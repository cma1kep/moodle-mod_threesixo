...
require_once($CFG->dirroot . '/mod/threesixo/backup/moodle2/restore_threesixo_stepslib.php'); // Because it exists (must)

/**
 * threesixo restore task that provides all the settings and steps to perform one
...
class restore_threesixo_activity_task extends restore_activity_task {
    ...
    protected function define_my_steps() {
        // threesixo only has one structure step
